...
<!--          </a-col>-->
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('SKU基础资料表')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <purSupBasicData-modal ref="modalForm" @ok="modalFormOk"></purSupBasicData-modal>
  </a-card>
</template>

<script>
  import PurSupBasicDataModal from './modules/PurSupBasicDataModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "PurSupBasicDataList",
    mixins:[JeecgListMixin],
    components: {
      PurSupBasicDataModal
    },
    data () {
      return {
        description: 'SKU基础资料表管理页面',
        // 表头
        columns: [
          {
            title: '#',
       ...
       //     },
		...
		url: {
          list: "/scan/purSupBasicData/list",
          delete: "/scan/purSupBasicData/delete",
          deleteBatch: "/scan/purSupBasicData/deleteBatch",
          exportXlsUrl: "scan/purSupBasicData/exportXls",
          importExcelUrl: "scan/purSupBasicData/importExcel",
       },
    }
  },
  computed: {
