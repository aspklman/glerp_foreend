<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="地点编号">
              <a-input placeholder="请输入地点编号" v-model="queryParam.locArea"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :md="6" :sm="8">
              <a-form-item label="区域编号">
                <a-input placeholder="请输入区域编号" v-model="queryParam.locNo"></a-input>
              </a-form-item>
            </a-col>
            <!--          <a-col :md="6" :sm="8">-->
            <!--            <a-form-item label="仓库栋别">-->
            <!--              <a-input placeholder="请输入仓库栋别" v-model="queryParam.buildingNo"></a-input>-->
            <!--            </a-form-item>-->
            <!--          </a-col>-->
          </template>
          <a-col :md="6" :sm="8">
    ...
    <!-- 表单区域 -->
    <areas-modal ref="modalForm" @ok="modalFormOk"></areas-modal>
  </a-card>
</template>
