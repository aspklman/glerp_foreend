...
<!--          label="locakRmk">-->
<!--          <a-input placeholder="请输入locakRmk" v-decorator="['locakRmk', {}]" />-->
<!--        </a-form-item>-->
<!--        <a-form-item-->
<!--          :labelCol="labelCol"-->
<!--          :wrapperCol="wrapperCol"-->
...
<!--          :wrapperCol="wrapperCol"-->
<!--          label="责任人">-->
<!--          <a-input placeholder="请输入责任人" v-decorator="['dutyPer', {}]" />-->
<!--        </a-form-item>-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        locDesc:{rules: [{ required: true, message: '请输入存放区说明!' }]},
        },
        url: {
          add: "/stock/locate/add",
          edit: "/stock/locate/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'locakRmk','factNo','stkNo','locNo','locDesc','dutyPer'))
		  //时间格式化
        });
