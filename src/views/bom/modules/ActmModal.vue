...
<!--        </a-form-item>-->
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="外包制程">
          <j-dict-select-tag v-decorator="['outworkRmk', validatorRules.outworkRmk ]" :type="'radio'" dictCode="yn_status" :triggerChange="true" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        outworkRmk:{rules: [{ required: true, message: '请输入外包制程(Y_N)!' }], initialValue: 'N'},
        },
        url: {
          add: "/bom/actm/add",
          edit: "/bom/actm/edit",
