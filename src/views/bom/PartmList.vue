...
<!--                </a-select>-->
    ...
    <div class="table-operator">
      <a-button v-has="'partm:add'"@click="handleAdd" type="primary" icon="plus">新增</a-button>
      <a-button v-has="'partm:exportXls'" type="primary" icon="download" @click="handleExportXls('部位表')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl"
                @change="handleImportExcel">
        <a-button v-has="'partm:importExcel'" type="primary" icon="import">导入</a-button>
      </a-upload>
      <a-dropdown v-if="selectedRowKeys.length > 0">
        ...
        <a-button v-has="'partm:deleteBatch'" style="margin-left: 8px"> 批量操作
          <a-icon type="down"/>
        </a-button>
      </a-dropdown>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a v-has="'partm:edit'" @click="handleEdit(record)">编辑</a>
    ...
    <!-- 表单区域 -->
    <partm-modal ref="modalForm" @ok="modalFormOk"></partm-modal>
  </a-card>
</template>
