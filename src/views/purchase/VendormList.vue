...
<!--          </a-col>-->
    ...
    <div class="table-operator">
      <a-button v-has="'vendorm:add'" @click="handleAdd" type="primary" icon="plus">新增</a-button>
      <a-button v-has="'vendorm:exportXls'" type="primary" icon="download" @click="handleExportXls('供应商表')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button v-has="'vendorm:importExcel'" type="primary" icon="import">导入</a-button>
      </a-upload>
      <a-dropdown v-if="selectedRowKeys.length > 0">
        <a-menu slot="overlay">
          <a-menu-item key="1" @click="batchDel"><a-icon type="delete"/>删除</a-menu-item>
        </a-menu>
        <a-button v-has="'vendorm:deleteBatch'" style="margin-left: 8px"> 批量操作 <a-icon type="down" /></a-button>
      </a-dropdown>
    </div>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a v-has="'vendorm:edit'" @click="handleEdit(record)">编辑</a>
